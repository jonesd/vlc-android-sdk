...
public abstract class AWindowNativeHandler {
   ...
   */
  @SuppressWarnings("unused") /* Used by JNI */ protected abstract Surface getVideoSurface();
   ...
   * @return can be null if the surface was destroyed.
   */
  @SuppressWarnings("unused") /* Used by JNI */ protected abstract Surface getSubtitlesSurface();
   ...
   */
  @SuppressWarnings("unused") /* Used by JNI */ protected abstract boolean setCallback(long nativeHandle);
   ...
   */
  @SuppressWarnings("unused") /* Used by JNI */ protected abstract boolean setBuffersGeometry(Surface surface, int width, int height, int format);
   ...
   */
  @SuppressWarnings("unused") /* Used by JNI */ protected abstract void setWindowLayout(int width, int height, int visibleWidth, int visibleHeight,
   ...
   *
   */
  @SuppressWarnings("unused") /* Used by JNI */ protected abstract void sendHardwareAccelerationError();
}