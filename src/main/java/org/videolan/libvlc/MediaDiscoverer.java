...
@SuppressWarnings("unused, JniMissingFunction") public class MediaDiscoverer extends VLCObject<MediaDiscoverer.Event> {
  ...
  @SuppressWarnings("unused") /* Used from JNI */ private static Description createDescriptionFromNative(String name, String longName, int category) {
  ...
  @Override protected void onReleaseNative() {
    if (mMediaList != null) mMediaList.release();
    nativeRelease();
  }
   ...
   */
  @Nullable public static Description[] list(LibVLC libVLC, int category) {
